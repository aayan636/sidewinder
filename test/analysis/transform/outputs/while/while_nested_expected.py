...
while not __sidewinder_fixed_point1:
    ...
    __sidewinder_fixed_point3 = False
    while not __sidewinder_fixed_point3:
        __sidewinder_condition_true__(__sidewinder_cond2, __sidewinder_state=__sidewinder_state)
        z1
        __sidewinder_cond2 = __sidewinder_union__(__sidewinder_cond2, y, __sidewinder_state=__sidewinder_state)
        __sidewinder_fixed_point3 = __sidewinder_fixed_point__(__sidewinder_state=__sidewinder_state)
