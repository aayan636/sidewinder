...
__sidewinder_cond3, __sidewinder_discard4 = __sidewinder_exception_condition_and_object__(None, already_handled=[__sidewinder_cond1], __sidewinder_state=__sidewinder_state)
__sidewinder_condition_true__(__sidewinder_cond3, __sidewinder_state=__sidewinder_state)
x = 3
__sidewinder_pop_condition__(__sidewinder_state=__sidewinder_state)